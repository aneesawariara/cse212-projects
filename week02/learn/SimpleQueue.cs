public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Tried to remove from index 1 instead of 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Inserting from the front of the queue
    ...
    private void Enqueue(int value) {
        _queue.Insert(0, value); //Add to the end of the queue instead of the front
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[1]; // list starts from index 1
        _queue.RemoveAt(1);
        return value;
    }
}